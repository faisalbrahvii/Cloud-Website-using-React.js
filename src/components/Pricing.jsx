      ...
      <div className='w-full h-[800px] bg-slate-900 absolute mix-blend-overlay'></div>
            ...
            <div className='max-w-[1240px] mx-auto py-12'>
                <div className='text-center py-8 text-slate-300'>
                    ...
                    <p className='text-3xl'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eius dolor odit totam ipsam ratione, inventore tempore? Temporibus distinctio vitae molestiae?</p>
                </div>
                ...
                <div className='grid md:grid-cols-2'>
                  <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
                    ...
                    <div>
                        <p className='text-6xl font-bold py-4 flex' >$48<span className='text-xl text-slate-500 flex flex-col justify-end'>/mo</span></p>
                    </div>
